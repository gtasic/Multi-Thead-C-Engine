//C'est le main avec optimisation
//sim2.exe est le fichier exécutable associé avec compilateur en mode débug
//benchmark.exe est le fichier exécutable associé avec compilateur sans mode débug
...
int main(){
    ...
    std::cout<<"Engine optimized"<<std::endl;
    
    std::vector<std::byte> buffer(200 * 1024 * 1024);
